...
public class ZooManagement {
            ...
            try {
                switch (choice) {
                    case 1:
                        ...
                        zoo.addAnimal(new Terrestrial(family, name, age, isMammal, nbrLegs));
                        break;
                    ...
                    case 2:
                        ...
                        zoo.addAnimal(new Dolphin(family, name, age, isMammal, dolphinHabitat, swimmingSpeed));
                        break;
                    ...
                    case 3:
                        ...
                        zoo.addAnimal(new Penguin(family, name, age, isMammal, penguinHabitat, swimmingDepth));
                        break;
                ...
                // Affichage du nombre d'animaux après chaque ajout
    ...
    public static void testNewAquaticFeatures(Zoo zoo) {
    ...
    private static void testAquaticAnimals() {
        try {
            ...
            // On ne peut plus créer d'instance directe de Aquatic car c'est une classe abstraite
