...
import gestionzoo.gestionemployes.Employe;
...
import gestionzoo.gestionemployes.SocieteArrayList;

import java.util.Scanner;

public class ZooManagement {
    private static Scanner scanner = new Scanner(System.in);
    private static SocieteArrayList societe = new SocieteArrayList();
    ...
    private static void displayMenu() {
        ...
        System.out.println("10. Gestion des employés");
    ...
    private static void displayEmployeMenu() {
        ...
        System.out.println("5. Trier les employés par ID");
        System.out.println("6. Trier les employés par nom de département et grade");
        System.out.println("7. Retour au menu principal");
    }

    private static void addNewEmploye() {
        ...
        System.out.print("Entrez le grade de l'employé : ");
    ...
    private static void removeEmploye() {
        System.out.print("Entrez le nom de l'employé à supprimer : ");
        String nom = scanner.nextLine();
        Employe employe = new Employe();
        employe.setNom(nom);
        if (societe.supprimerEmploye(employe)) {
    ...
    private static void searchEmploye() {
        ...
        String nom = scanner.nextLine();
        if (societe.rechercherEmploye(nom)) {
